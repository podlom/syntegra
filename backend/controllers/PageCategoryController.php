...
use backend\models\PageCategorySearch;
...
class PageCategoryController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $isAdmin = $isSeo = $isContent = 0;
        if (! Yii::$app->user->isGuest) {
            $isAdmin = UserHelper::isAdmin(Yii::$app->user->id);
            //$isSeo = UserHelper::isSeo(Yii::$app->user->id);
           // $isContent = UserHelper::isContent(Yii::$app->user->id);
        }
