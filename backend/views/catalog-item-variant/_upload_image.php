    ...
    $.ajax({
      ...
      success: function(data) {
        if (data.length > 0) {
            ...
            $('#catalogitemvariant-img_url').attr('value', data);
        }
        $('#modal1').modal('hide');
      }
    });
...
$form = ActiveForm::begin(['action' => ['/catalog-item-variant/upload-img'], 'id' => 'upload-category-img-form1', 'options' => ['enctype' => 'multipart/form-data']]) ?>
